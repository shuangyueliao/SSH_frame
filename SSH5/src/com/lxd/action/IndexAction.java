...
//		}
		//System.out.println("###############IndexAction######showList###############++++++++++++++++++++++");
		String hql="from News order by id desc";
		String hql1="from Project order by id desc";
		//System.out.println("##################################################%%%%%%#####IndexAction###showList##############################");
		//System.out.println("######"+hql);
		//System.out.println("######"+hql1);
		request.put("newsList",newsDao.excuteQueryByPage(hql, 1, 5));
		request.put("projectList",projectDao.excuteQueryByPage(hql1, 1,5));
