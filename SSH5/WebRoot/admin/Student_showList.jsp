...
<table class="list_tab" align="center" width="80%" cellspacing="1" bordercolor="#44AEDB"  cellpadding="1" border="1">
			      ...
			      <tr>
				    ...
				    <td width="29%" bgcolor="#F1F3F5"><a href="<%=basePath%>admin/Student_updateInput.action?id=${teacher.id}" target="_self">【编辑】</a>
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=basePath%>admin/Student_delete.action?id=${teacher.id}" target="_self" onclick="delComit()">【删除】</a></td>
		          </tr>
				  ...
				  <tr>
				    ...
				    <td colspan="2" bgcolor="#E4EDF9"><s:property value="#student.grade.name" /></td>
			      </tr>
				  <tr>
